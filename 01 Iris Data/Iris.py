...
# Number of neighbours considered for the K-NN algorithm
n_neighbours = 5

# Initialization of K-NN classifier model
knn_mod = neighbors.KNeighborsClassifier(n_neighbours,
                                         weights = "distance")
...
Accuracy = np.round(sum(y_pred == y_test) / len(y_pred), 4)
print(Accuracy)